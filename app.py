...
def norm(m):
    ...
    for f in ("title", "date", "emoji", "about"):
        out[f] = (out.get(f) or DEFAULTS[f]).strip()
    return out
...
def _petals(n=10):
    return "".join(
        ...
        f'--s:{rng.uniform(8,15):.1f}px;--x:{rng.uniform(-100,100):.0f}px"></span>'
        for _ in range(n))

PARTICLES = (
    '<div class="living-bg" id="living-bg">'
    '<div class="soft-glow"></div>'
    f'{_bokeh(4)}{_p("bubble",8)}{_p("leaf",6)}{_p("dot",14)}{_petals(10)}'
    '</div>'
)
...
<style>
  ...
  p.love-sub{font-family:'Cormorant Garamond',serif !important;font-weight:800;font-style:italic;
    ...
    border:2px solid #7a0a1e;border-radius:999px;background:rgba(255,255,255,.88);
  ...
  .tl-title{font-family:'Lora',serif;font-style:italic;font-weight:700;font-size:1.55rem;color:#04160C;
    line-height:1.25;margin:2px 0 8px 0;-webkit-text-stroke:.5px #04160C}
  .tl-date{display:inline-block;font-family:'Cormorant Garamond',serif;font-style:italic;font-weight:700;
    font-size:.9rem;letter-spacing:.22em;text-transform:uppercase;color:#4a0312;padding:4px 14px;
  ...
  .empty-hint{display:inline-block;margin-top:16px;font-family:'Inter',sans-serif;font-weight:700;
    font-size:.85rem;letter-spacing:.14em;text-transform:uppercase;color:#fff;padding:9px 20px;
    border-radius:999px;background:linear-gradient(135deg,#0d3b25 0%,#1c6b3f 55%,#2e9e63 100%);
    border:2px solid #062b18;box-shadow:0 6px 18px rgba(6,43,24,.4)}
  .no-photo{max-width:820px;margin:24px auto 22px auto;padding:56px 30px;border-radius:20px;
  ...
  .ending-title{font-family:'Great Vibes',cursive;font-size:2.7rem;color:#04160C;margin:4px 0 10px 0;
  ...
  .reasons-head{
    ...
    color:#0a0704;
    margin:0 0 20px 0;
    -webkit-text-stroke:0.8px #0a0704;
    text-shadow:0 2px 6px rgba(122,10,30,.35);
}
  ...
  .stButton>button{background:linear-gradient(135deg,#0d3b25 0%,#1c6b3f 55%,#2e9e63 100%);
    ...
    box-shadow:0 8px 22px rgba(6,43,24,.5),inset 0 1px 2px rgba(255,255,255,.3);
  ...
  .stButton>button:hover{background:linear-gradient(135deg,#14532d 0%,#237a4a 55%,#3ab877 100%);
    border-color:#0d3b25;transform:translateY(-2px) scale(1.03);
    box-shadow:0 14px 32px rgba(6,43,24,.7),inset 0 1px 3px rgba(255,255,255,.5)}
  ...
  .stFileUploader label,.stMultiSelect label{color:#0B2E1A !important;
  ...
  .stFileUploader section{background:#fff5f9 !important;border:2px dashed #7a0a1e !important;
  ...
  section[data-testid="stFileUploadDropzone"] button{
    ...
    color:#fff !important;border:2px solid #062b18 !important;border-radius:999px !important;
...
components.html(f"""<style>
  ...
  .days-counter{{display:inline-flex;align-items:center;gap:14px;padding:14px 28px;border-radius:999px;
    ...
    box-shadow:0 12px 34px rgba(11,46,26,.35);font-family:'Inter',sans-serif;color:#04160C}}
